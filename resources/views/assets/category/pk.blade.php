...
<div class="flex items-center justify-between mb-4">
    ...
    <a href="{{ route('assets.create', ['category' => 'PK']) }}" class="bg-green-600 text-white px-3 py-1.5 rounded text-xs hover:bg-green-700">+ Tambah Perangkat Keras</a>
</div>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td colspan="11" class="px-4 py-8 text-center text-gray-500">
                        Belum ada data Perangkat Keras. 
                        <a href="{{ route('assets.create', ['category' => 'PK']) }}" class="text-blue-600 hover:underline">Tambah sekarang</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
