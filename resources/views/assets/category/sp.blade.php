...
<div class="flex items-center justify-between mb-4">
    ...
    <a href="{{ route('assets.create', ['category' => 'SP']) }}" class="flex items-center gap-1.5 bg-blue-600 text-white px-4 h-9 rounded text-sm hover:bg-blue-700 shadow-sm shadow-blue-300 transition-colors">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-xs whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                @empty
                <tr><td colspan="11" class="px-4 py-8 text-center text-gray-500">Belum ada data {{ $pageTitle }}. <a href="{{ route('assets.create', ['category' => 'SP']) }}" class="text-blue-600 hover:underline">Tambah sekarang</a></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
