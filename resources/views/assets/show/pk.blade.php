...
@section('title', 'Detail Aset - Perangkat Keras')
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-5 shadow-md mb-4">
        <h3 class="text-xs font-semibold text-blue-600 uppercase tracking-wider mb-3 border-b pb-2">Detail Perangkat Keras</h3>
